...
<body class="d-flex align-items-center py-4 bg-light">
 <main class="form-signin w-30 m-auto">
    <form  onsubmit="return false;">
            ...
            <button id="btn" class="btn btn-primary w-100 py-2" type="submit">ورود</button>
    
    </form>
    <span id="showError"></span><br>
    <button id="btnr" class="btn btn-primary w-100 py-2"><a href="register" style="color: aliceblue;">ثبت نام</a></button>
